...
[![Status](https://img.shields.io/badge/Status-Production%20Ready-00F5D4?style=for-the-badge&logo=vercel&logoColor=black)](https://github.com/adityashp2/Portofolio)
...
Saya adalah seorang **System Analyst** dan **Fullstack Web Developer** berlatar belakang pendidikan **D4 Teknologi Rekayasa Perangkat Lunak (TRPL) Politeknik Negeri Lampung**, sekaligus mengemban amanah sebagai **Gubernur Jurusan Teknologi Informasi (2025—2026)**.

Fokus utama saya adalah menjembatani kebutuhan bisnis (*business requirements*) dengan arsitektur teknis perangkat lunak terukur melalui:
- **Analisis & Spesifikasi Sistem**: Penyusunan dokumen *Software Requirements Specification* (SRS), pemodelan alur bisnis (*UML*, *BPMN 2.0*), serta perancangan skema basis data relasional (*ERD* & *DFD*).
- **Rekayasa Web Skalabel**: Membangun platform web modern menggunakan *Next.js*, *React 19*, *TypeScript*, *Tailwind CSS*, *PostgreSQL*, arsitektur *Multi-Tenant*, serta integrasi *Payment Gateway*.

Portofolio ini dibangun dengan standar arsitektur bersih, tipografi editorial kontras tinggi (*Space Grotesk* & *Inter*), optimasi performa *Lighthouse*, serta pipeline otomatis generator CV berbasis Headless Browser.
...
- **Kolaborasi Lintas Tim**: Menjembatani komunikasi pemangku kepentingan (*board of directors*, institusi pendidikan, klien UMKM) ke tim teknis engineering.

---

## 🚀 Featured Engineering Case Studies

### 1. [CahFin.com](https://cahfin.com) — SaaS Financial Management ERP Multi-Tenant Yayasan
*Fullstack Web Developer Intern — Code At Home & Yayasan Al-Bana (2026)*

Platform SaaS manajemen keuangan multi-tenant komprehensif yang dirancang untuk mengelola tata kelola finansial yayasan pendidikan terpadu (TK, SDIT, SMPIT, SMA, SMK, hingga Universitas).
- **Arsitektur Multi-Tenant Terisolasi**: Subdomain dinamis otomatis per unit institusi yayasan dengan isolasi partisi data dan audit trail terperinci.
- **Modul RKAS & Budget Guard**: Pemantauan serapan pagu anggaran secara real-time yang secara otomatis mencegah pengeluaran melebihi batas alokasi (anti-defisit).
...
### 2. [CahTix.com](https://cahtix.com) — Platform Ticketing & Real-Time Voting Event Lampung
*Fullstack Web Developer Intern — Code At Home (2026)*

Platform digital penjualan tiket online dan pemungutan suara pemilihan real-time terdepan di wilayah Lampung untuk acara konser musik, seminar, dan festival bakat.
- **Mesin Booking & E-Ticket**: Alur checkout reservasi tiket event interaktif dengan kuota real-time dan penerbitan tiket elektronik ber-QR code unik.
- **Sistem Voting Real-Time Anti-Fraud**: Perhitungan suara transparan dan leaderboard langsung per kandidat dengan validasi pencegahan kecurangan.
...
### 3. [PensiunMudah.my.id](https://pensiunmudah.my.id) — Platform Edukasi & Sertifikasi Masa Pra-Pensiun
*System Analyst Intern — Indonesian Certification Center (ICC), Yogyakarta (2025—2026)*

Platform pelatihan digital dan sertifikasi kompetensi yang dirancang khusus untuk aparatur dan karyawan swasta menjelang masa purna tugas.
- **Analisis Kebutuhan Sistem & SRS**: Merumuskan dokumen kebutuhan perangkat lunak formal dan wawancara pemangku kepentingan.
...
### 4. terraServe Mobile System — Aplikasi Manajemen Layanan Presisi
...
### 5. Infrastruktur Jaringan & Server UPA TIK Polinela
...
| Sertifikat / Penghargaan | Penerbit / Lembaga | Periode |
|---|---|---|
| **Sertifikat Penghargaan Magang Industri (Digital Marketing & System)** | Indonesian Certification Center (ICC), Yogyakarta | 2026 |
| **Piagam & SK Kepemimpinan Organisasi Gubernur Jurusan TI** | Politeknik Negeri Lampung | 2025 — 2026 |
| **Sertifikasi Kompetensi Web Development** | Kompetensi Kejuruan & Pelatihan TI | Pengembangan Perangkat Lunak |
